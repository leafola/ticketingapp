				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<div class="col-sm-8">
								<h5>
									<strong>Agent Account:</strong> {{ agent.fname }} {{
									agent.lname }}
								</h5>
							</div>
					...
					<div class="panel-body">
						...
						<div class="list-group"
							...
							<button type="button" class="btn btn-block btn-primary"
								...
								ng-class="{active: isActive(t)}"><span class="glyphicon glyphicon-folder-close"></span>{{ t.title }}</button>
						</div>
					</div>
				</div>
			</div>
			<div class="col-sm-8">
				...
				<div class="panel panel-default" ng-show="showPosts">
					<div class="panel-heading">
						<div class="row">
							<div class="col-sm-8">
								<h4><span class="glyphicon glyphicon-folder-open"></span>{{ postTitle }}</h4>
							</div>
							<div class="col-sm-4 text-right">
